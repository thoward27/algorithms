 ...
 * following the adjacency list method. Operates on an array of linked lists
 * with indexs in the array representing vertices and the elements of that
 * index's linked list represent verticies that vertex has an edge with.
 */
class Graph {
 private:
  std::vector<int>* list;
