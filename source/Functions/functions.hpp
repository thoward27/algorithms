 ...
 *
 * Inputs:
 * @param int: An integer representing an ASCII code to be converted to its
 ...
 *
 * Inputs:
 * @param int: A set of integers (either in an array or small numbers of
 * integers) to find the max of
 *
 * Outputs:
 ...
 *
 * Examples:
 * is_sorted([1,2,3],3) == 1, is_sorted([3,2,1],3) == 1, is_sorted([3,2,3],3) ==
 * 0
 *
 * Runtime:
 * O(n)
